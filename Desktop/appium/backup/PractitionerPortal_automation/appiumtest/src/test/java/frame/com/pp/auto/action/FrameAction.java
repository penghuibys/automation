...
public class FrameAction {
	...
	public void back(String description){
		try{
			pageAction.back();;
			LogUtil.step("Back to previous Page, Passed", description);
		}
		catch(Exception e){
			FrameAssertion.fail("Back to previous Page, Failed", description);
		}
	}
	...
	public void mouseMove(By by, String description){
		try{
			baseAction.mouseMove(this.driver,finder.find(by));
			LogUtil.step("Move to WebElement" + by.toString() + ", Passed", description);
		}
		catch(Exception e){
			FrameAssertion.fail("Move to WebElement " + by.toString() + ", Failed", description);
		}
	}
	
	public void mouseRightKey(By by, String description){
		try{
			baseAction.mouseRightKey(this.driver,finder.find(by));
			LogUtil.step("Rightkey on WebElement" + by.toString() + ", Passed", description);
		}
		catch(Exception e){
			FrameAssertion.fail("Rightkey on WebElement " + by.toString() + ", Failed", description);
		}
	}
