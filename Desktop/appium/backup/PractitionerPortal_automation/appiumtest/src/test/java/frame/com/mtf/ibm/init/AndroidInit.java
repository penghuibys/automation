...
public class AndroidInit {
  ...
  //      capabilities.setCapability("resetKeyboard", true);//hide keyboard
        ...
        capabilities.setCapability("appActivity", "com.ss.android.article.lite.activity.SplashActivity");
...
//		}
	...
	public AndroidDriver<WebElement>launchTikTokApp(){
		//Local device configuration
		DesiredCapabilities capabilities = new DesiredCapabilities();
		capabilities.setCapability("deviceName","huawei mate9");
		capabilities.setCapability("platformName", "android");
		//      capabilities.setCapability("unicodeKeyboard", true);//Chinese input
		//      capabilities.setCapability("resetKeyboard", true);//hide keyboard
		capabilities.setCapability("appPackage", "com.ss.android.ugc.aweme.lite");
...
//        capabilities.setCapability("noSign", true);
	...
	public AndroidDriver<WebElement>launchKsApp(){
		//Local device configuration
		DesiredCapabilities capabilities = new DesiredCapabilities();
		capabilities.setCapability("deviceName","huawei mate9");
		capabilities.setCapability("platformName", "android");
		//      capabilities.setCapability("unicodeKeyboard", true);//Chinese input
		//      capabilities.setCapability("resetKeyboard", true);//hide keyboard
		capabilities.setCapability("appPackage", "com.kuaishou.nebula");
...
//        capabilities.setCapability("noSign", true);
	...
	public AndroidDriver<WebElement>launchHsApp(){
		//Local device configuration
		DesiredCapabilities capabilities = new DesiredCapabilities();
		capabilities.setCapability("deviceName","huawei mate9");
		capabilities.setCapability("platformName", "android");
		//      capabilities.setCapability("unicodeKeyboard", true);//Chinese input
		//      capabilities.setCapability("resetKeyboard", true);//hide keyboard
		capabilities.setCapability("appPackage", "com.ss.android.ugc.livelite");
		capabilities.setCapability("appActivity", "com.ss.android.ugc.live.main.MainActivity");
		capabilities.setCapability("noReset", true);
		capabilities.setCapability("newCommandTimeout", 1000);
//        capabilities.setCapability("noSign", true);
		capabilities.setCapability("autoGrantPermissions", true);
